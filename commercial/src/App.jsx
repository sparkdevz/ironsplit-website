      ...
      <motion.div className="flex flex-col items-center relative z-10">
        ...
        <motion.a
          ...
          style={{
            ...
            background: '#1a1a1a', border: '0.15vw solid rgba(255,255,255,0.15)',
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.1 }}>
            ...
            <span style={{ fontSize: '2.2vw', color: '#ffffff', fontFamily: "'Anton', sans-serif", letterSpacing: '0.03em' }}>Google Play</span>
          </div>
        </motion.a>
      </motion.div>
    </div>

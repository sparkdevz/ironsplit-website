  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-brand-dark flex items-center justify-center font-body">
      ...
      <a
        ...
        className="absolute bottom-[3vw] left-[3vw] z-50 flex items-center gap-[0.8vw] font-display text-[1.2vw] tracking-wider uppercase no-underline transition-all"
        style={{ background: 'rgba(0,0,0,0.65)', backdropFilter: 'blur(8px)', border: '1px solid rgba(245,158,11,0.5)', color: '#ffffff', padding: '0.7vw 1.5vw', borderRadius: '999px', textDecoration: 'none' }}
      >
